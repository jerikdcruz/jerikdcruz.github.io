...
<details style="margin-bottom: 8px;">
<summary> "From Precarity to Illiberalism: The Political Economy of Democratic Erosion in the Philippines" <i>(with Enrico Antonio La Viña)</i> </summary>
<br>
Why have beneficiaries of economic booms frequently supported illiberal leaders in developing democracies? While past explanations of populism have emphasized the role of disinformation and ethnic/identity-based appeals, these accounts struggle to explain why core supporters of illiberal leaders in the Global South have often come from upwardly-mobile classes that have benefited from accelerated growth and poverty reduction. We argue that the services transition in the Global South has underpinned the expansion of ``non-poor yet insecure'' working/middle classes that are less integrated into formal civil society and informal clientelist networks. These process have, in turn, expanded the feasibility of illiberal-populist political strategies. Through mixed-method case studies of the Philippines' Rodrigo Duterte and Ferdinand Marcos, Jr. in 2016 and 2022, we show that such groups were tapped as major constituencies by both presidents in their campaigns, and that a ``precarious class'' perspective better comports with the dynamics of these voting demographics. Our argument provides reason for reassessing the scope conditions underlying Lipset’s Law on the relationship between economic development and democracy.
</details>

<details style="margin-bottom: 8px;">
<summary> "Bayesian inference and typological thinking: an integrated framework for typological & computational research" </summary>
<br>
  Social scientists often update typologies when faced with observations that do not fit existing classification schemes. But the process of establishing such new categories is often undertaken in an ad-hoc manner that is over-fitted to individual observations. I re-purpose recent advances in incorporating abductive and Bayesian reasoning in iterative research to provide more systematic guidelines for typological updating processes. Specifically, I reframe typological updating as a problem of <i>completing</i> incomplete typologies, for which abductive and Bayesian reasoning represent complementary approaches to updating that are often conflated by researchers. Abduction addresses questions of whether and on what typological dimensions <i>formulating</i> new types is analytically appropriate. Bayesian reasoning aids in adjudicating whether <i>retaining</i> proposed new types is justified. Beyond providing more safeguards for typological updating processes, grounding typological updating in these frameworks offers the possibility for a integrated framework for iterative research bridging emerging streams of typological and computational social science research.
